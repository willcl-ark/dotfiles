...
local on_attach = function(client, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ld", "<cmd>lua require('telescope.builtin').lsp_definitions()<CR>",
        opts)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>lr", "<cmd>lua require('telescope.builtin').lsp_references()<CR>",
        opts)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader><leader>f", "<cmd>lua vim.lsp.buf.format({ async = true })<CR>",
        opts)
    vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader><leader>rf", "<cmd>lua vim.lsp.buf.range_formatting()<CR>", opts)
...
require("mason-lspconfig").setup_handlers({
    ...
    ["clangd"] = function()
        require("lspconfig").clangd.setup {
            ...
            root_dir = nvim_lsp.util.root_pattern('.git', 'Makefile.am'),
        }
    end,
