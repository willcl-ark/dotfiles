return {
  {
    ...
    config = function()
      ...
      -- File Pickers
      vim.keymap.set( "n", "<leader>sf", function() require("telescope.builtin").find_files({ layout_config = { horizontal = { preview_width = 0.75 }, }, }) end, { desc = "[S]earch [F]iles" })
      ...
      vim.keymap.set("n", "<leader>sb", function() require("telescope.builtin").current_buffer_fuzzy_find({ fuzzy = false, case_mode = "ignore_case" }) end, { desc = "[S]earch [B]uffer Fuzzily search in current buffer]" })
